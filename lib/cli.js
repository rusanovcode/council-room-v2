...
async function runCodex(prompt, { workdir, model = "", effort = "auto", outFile = "", logFile = "", onStream, isolated = true, signal, onChild } = {}) {
...
async function runClaude(prompt, { workdir, model = "", effort = "auto", logFile = "", onStream, isolated = true, signal, onChild } = {}) {
