...
2. **Спросить пользователя**: что делаем дальше? (Phase 2 закрыт; поверх него построены цикл вопросов, мультиаккаунт/свитч+gateway, архив/корзина, статистика — см. §10. Не закрыто: Phase 3 панель/Phase 4 gate; отложено: Codex OAuth-usage.)
