...
## Phase 6 — осталось (6c)
- **6c (реестр)**: «Профили и роли» → «Регистрация агентов» (регистрация + авторизация); новый столбик-иконок зарегистрированных агентов (оверлей справа над чатом, раскрытие влево, не ломая grid). Что отображать в столбике — доисследовать. Редакторы ролей A/B из Phase 5 убрать (выбор переехал в чипы центра).
